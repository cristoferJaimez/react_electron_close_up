...
import { faCubes, faBed, faFile } from "@fortawesome/free-solid-svg-icons";
...
function File_() {
  ...
  const list_process = (e) => {
    ...
    if (che === true) {
      ...
      localStorage.setItem("list_order_file_", JSON.stringify(order_process));
      var getOrder = localStorage.getItem("list_order_file_");
