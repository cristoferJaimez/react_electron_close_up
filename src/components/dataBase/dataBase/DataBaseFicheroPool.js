...
// listar
const GET_DATA_BASE_MAESTRO_POOL = gql`
  {
    apellido{
    _id
    APELLIDOS
...
function DataBaseFicheroPool() {
    //modals

    //end modal

    const { loading, error, data } = useQuery(GET_DATA_BASE_MAESTRO_POOL);
...
export default DataBaseFicheroPool;
